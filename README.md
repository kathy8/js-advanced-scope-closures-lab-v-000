...
Create the following functions:
  ...
  + `createDriver` returns a function that returns a class that produces a Driver class.  The class has reference to a driverId that is incrementes not have access to driverId.  
